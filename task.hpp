...
*/
template <typename C>
class is_static_task_t{
public:
    static constexpr bool v =   is_invocable_t<void, C>::value &&
                                !is_invocable_t<int, C>::value;
};
//template <typename C>
//constexpr bool is_static_task_v = is_invocable_t<void, C>::value &&
//                                 !is_invocable_t<int, C>::value;
...
template <typename C>
    class is_dynamic_task_t{
    public:
        static constexpr bool v =   is_invocable_t<void, C, Subflow&>::value;
};

//template <typename C>
//constexpr bool is_dynamic_task_v = is_invocable_t<void, C, Subflow&>::value;
...
template <typename C>
class is_condition_task_t{
    public:
        static constexpr bool v =   is_invocable_t<int, C>::value;
    };

//template <typename C>
//constexpr bool is_condition_task_v = is_invocable_t<int, C>::value;
...
class Task {
  ...
  public:
    ...
    */
    template <typename C>
    std::enable_if_t<is_static_task_t<C>::v, Task>& work(C&& callable);
    ...
    */
    template <typename C>
    std::enable_if_t<is_dynamic_task_t<C>::v, Task>& work(C&& callable);
    ...
    */
    template <typename C>
    std::enable_if_t<is_condition_task_t<C>::v, Task>& work(C&& callable);
...
template <typename C>
std::enable_if_t<is_static_task_t<C>::v, Task>& Task::work(C&& c) {
...
template <typename C>
std::enable_if_t<is_dynamic_task_t<C>::v, Task>& Task::work(C&& c) {
...
template <typename C>
std::enable_if_t<is_condition_task_t<C>::v, Task>& Task::work(C&& c) {
