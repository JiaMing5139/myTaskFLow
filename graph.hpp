...
class Node {
  ...
  // variant index
  constexpr static auto PLACEHOLDER_WORK = get_index_t<nstd::monostate, handle_t>::value;
  constexpr static auto STATIC_WORK      = get_index_t<StaticWork, handle_t>::value;
  constexpr static auto DYNAMIC_WORK     = get_index_t<DynamicWork, handle_t>::value;
  constexpr static auto CONDITION_WORK   = get_index_t<ConditionWork, handle_t>::value;
  constexpr static auto MODULE_WORK      = get_index_t<ModuleWork, handle_t>::value;
